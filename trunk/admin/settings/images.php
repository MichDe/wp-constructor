...
<table class="form-table">
    ...
    <tr>
        <th scope="row" valign="top" rowspan="4"><?php _e('Background Image', 'constructor'); ?></th>
        <td>
    ...
    <tr>
        <th scope="row" valign="top" rowspan="3"><?php _e('Content Image', 'constructor'); ?></th>
        <td>
    ...
    <tr>
        <th scope="row" valign="top" rowspan="3"><?php _e('Sidebar Image', 'constructor'); ?></th>
        <td>
    ...
    <tr>
        <th scope="row" valign="top" rowspan="3"><?php _e('Extrabar Image', 'constructor'); ?></th>
        <td>
    ...
    <tr>
        <th scope="row" valign="top" rowspan="3"><?php _e('Footer Image', 'constructor'); ?></th>
        <td>
