...
<?php if (!is_writable($directory .'/themes/'.$constructor['theme'].'/style.css')) : ?>
    ...
    <tr>
        <td class="td-full"><textarea name="null[css]" readonly="readonly"><?php echo file_get_contents($directory .'/themes/'.$constructor['theme'].'/style.css')?></textarea></td>
    </tr>
<?php else: ?>
    <tr>
        <td class="td-full"><textarea name="constructor[css]"><?php echo file_get_contents($directory .'/themes/'.$constructor['theme'].'/style.css')?></textarea></td>
    </tr>
<?php endif; ?>
</table>